...
CREATE TABLE IF NOT EXISTS `netkompetenz`.`Employee_has_Skill` (
  ...
  `idEmployee` INT(11) NOT NULL,
  `levelExpertise` INT NOT NULL,
  `levelInterest` INT NOT NULL,
  `IsTrainer` INT NOT NULL,
  PRIMARY KEY (`idEhs`),
  INDEX `fk_Employee_has_Skill_Employee1_idx` (`idEmployee` ASC),
  INDEX `fk_Employee_has_Skill_Skill1_idx` (`idSkill` ASC),
...
CREATE TABLE IF NOT EXISTS `netkompetenz`.`Group_has_Skill` (
  `idGhs` INT NOT NULL AUTO_INCREMENT,
  `idGroup` INT(11) NOT NULL,
  `idSkill` INT(11) NOT NULL,
